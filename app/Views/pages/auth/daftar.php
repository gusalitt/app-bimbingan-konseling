...
<head>
    ...
    <title>Daftar | App Bimbingan Konseling</title>
    <!-- TailwindCSS -->
...
<body class="font-Nunito bg-light-bg dark:bg-dark-bg overflow-auto py-3 text-light-text dark:text-dark-text relativ w-full">
    ...
    <div class="container w-full set-flex flex-col h-screen gap-2 mx-auto px-5 scale-100 lg:scale-90">
        ...
        <form action="<?= site_url('/daftar'); ?>" method="post" class="set-flex py-5 flex-col w-full md:w-[500px] mx-auto bg-light-card dark:bg-dark-card rounded-xl shadow-md">
            ...
            <div class="set-flex flex-col mb-4">
                ...
                <h2 class="text-2xl md:text-3xl font-semibold">Daftar</h2>
            </div>
            ...
            <ul class="set-flex flex-col w-full px-4 md:px-8 gap-4">
                ...
                <li class="w-full">
                    ...
                    <input
                        ...
                        class="basic-input focus:outline-none focus:shadow-outline <?= (session('errors.username')) ? 'border-pink-600 ring-1 ring-pink-600' : '' ?>"
                        value="<?= old('username') ?: ''; ?>">
                ...
                <li class="w-full">
                    ...
                    <div class="basic-input focus:outline-none focus:shadow-outline set-flex p-0 m-0 overflow-hidden <?= (session('errors.password')) ? 'border-pink-600 ring-1 ring-pink-600' : '' ?>">
                        ...
                        <span class="px-2.5 " id="eyeBtnPassword">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 cursor-pointer hidden" id="eyePassword">
                                <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z" clip-rule="evenodd" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 cursor-pointer" id="eyeSlashPassword">
                ...
                <li class="w-full">
                    ...
                    <div class="basic-input focus:outline-none focus:shadow-outline set-flex p-0 m-0 overflow-hidden <?= (session('errors.confirmPassword')) ? 'border-pink-600 ring-1 ring-pink-600' : '' ?>">
                        <input
                            type="password"
                        ...
                        <span class="px-2.5 " id="eyeBtnConfirmPassword">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 cursor-pointer hidden" id="eyeConfirmPassword">
                                <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z" clip-rule="evenodd" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 cursor-pointer" id="eyeSlashConfirmPassword">
                                <path d="M3.53 2.47a.75.75 0 0 0-1.06 1.06l18 18a.75.75 0 1 0 1.06-1.06l-18-18ZM22.676 12.553a11.249 11.249 0 0 1-2.631 4.31l-3.099-3.099a5.25 5.25 0 0 0-6.71-6.71L7.759 4.577a11.217 11.217 0 0 1 4.242-.827c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113Z" />
                                <path d="M15.75 12c0 .18-.013.357-.037.53l-4.244-4.243A3.75 3.75 0 0 1 15.75 12ZM12.53 15.713l-4.243-4.244a3.75 3.75 0 0 0 4.244 4.243Z" />
                                <path d="M6.75 12c0-.619.107-1.213.304-1.764l-3.1-3.1a11.25 11.25 0 0 0-2.63 4.31c-.12.362-.12.752 0 1.114 1.489 4.467 5.704 7.69 10.675 7.69 1.5 0 2.933-.294 4.242-.827l-2.477-2.477A5.25 5.25 0 0 1 6.75 12Z" />
                            </svg>
                ...
                <li class="w-full mt-2">
                    <button type="submit" class="text-white w-full py-1.5 rounded-md bg-custom-gradient shadow-md font-bold text-lg">Daftar</button>
                </li>

                <!-- Info -->
                <li class="w-full text-center">
                    <p>Sudah punya akun? | <a href="<?= site_url('/login'); ?>" class="text-danger m-0 underline text-center text-lg">Login</a></p>
                </li>
            </ul>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('eyeBtnPassword').addEventListener('click', function() {
                togglePasswordVisibility('password', 'eyePassword', 'eyeSlashPassword');
            });

            document.getElementById('eyeBtnConfirmPassword').addEventListener('click', function() {
                togglePasswordVisibility('confirmPassword', 'eyeConfirmPassword', 'eyeSlashConfirmPassword');
            });
