<div class="h-full w-full max-h-[450px] overflow-auto">
    <div id="calendar" class="calendar-year grid grid-cols-1 w-full lg:grid-cols-2 gap-8 md:gap-12 text-xs"></div>
</div>
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Element references
        const calendarElement = document.getElementById("calendar");
        const prevYearBtn = document.getElementById("prevMonth");
        const nextYearBtn = document.getElementById("nextMonth");
        ...
        function renderCalendar(year) {
            ...
            currentTime.textContent = `Tahun ${year}`;
            ...
            for (let month = 0; month < 12; month++) {
                ...
                displayMonthYear(month, year, calendarHeader);
                ...
                calendarWrapper.append(calendarHeader, calendarBody);
                calendarElement.append(calendarWrapper);
            }
        }


        function displayMonthYear(month, year, calendarHeader) {
            const header = document.createElement("div");
            header.classList.add("header");

            header.textContent = `${monthNames[month]} ${year}`;

            calendarHeader.append(header);
        }
        ...
        function highlightDate(day, month, year, dayEl) {
            ...
            if (dayJadwal.length > 0) {
                ...
                const expandButton = createExpandButton(dayJadwal.length, moreInfo);
        ...
        function createJadwalInfo(jadwalItem, backgroundColor) {
            ...
            detailButton.setAttribute('href', `<?= base_url(); ?>/jadwal/detail/${jadwalItem.hash_tanggal}?type=year`);
        ...
        function createExpandButton(extracCount, moreInfo) {
            ...
            expandButton.addEventListener('click', (event) => {
                ...
                const calendarRect = dateElement.closest('.calendar-wrapper').getBoundingClientRect();
